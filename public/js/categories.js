document.addEventListener("DOMContentLoaded", function () {
  document
    ...
    .addEventListener("submit", function (event) {
      ...
      const addCategoryErrorElement =
        document.getElementById("addCategoryError");
      ...
      fetch("/categories", {
        ...
        .then((data) => {
          if (data.success) {
            ...
            addCategoryErrorElement.innerText =
              "Category addition failed. Category already exists.";
